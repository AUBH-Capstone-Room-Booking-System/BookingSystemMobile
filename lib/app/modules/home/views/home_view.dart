      ...
      bottomNavigationBar: BottomNavBarWidget(currentIndex: 0,),
        body: Container(
          ...
          child:Column(
            ...
            children: [
              Text("Hello, ${name}",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 40),),
                    ...
                    children: [
                      Expanded(child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Center(child: Text("Book A Room",textAlign: TextAlign.center,style: TextStyle(
                            color: Colors.white,
                      ...
                      Expanded(child: Container(
                        ...
                        child: Center(child: Text("Visit Rooms",textAlign: TextAlign.center,style: TextStyle(
                            color: Colors.white,
                            fontWeight: FontWeight.bold
                        ),)),
                      )),
                    ...
                    children: [
                      Expanded(child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Center(child: Text("Edit Booking",textAlign: TextAlign.center,style: TextStyle(
                              color: Colors.white,
                              fontWeight: FontWeight.bold
                          ),)),
                        ),
                      ...
                      Expanded(child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Center(child: Text("View Favorite Rooms",textAlign: TextAlign.center,style: TextStyle(
                              color: Colors.white,
                              fontWeight: FontWeight.bold
                          ),)),
                        ),
